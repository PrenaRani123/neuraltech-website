        ...
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold text-primary-400 mb-4 animate-pulse">NeuralTech</h3>
              <p className="text-secondary-300 mb-6 leading-relaxed">
                We specialize in cutting-edge AI solutions, custom web development, and data analytics 
                that drive real business results. Transform your business with our innovative technology services.
              </p>
